...
function assertRelativeSafe(inputPath: string): void {
...
function ensureWithin(rootReal: string, candidate: string): void {
...
export async function resolveSandboxPath(root: string, inputPath: string): Promise<ResolvedPath> {
