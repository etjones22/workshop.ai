...
import { ensureConfigFile, loadConfig, redactConfig } from "./util/config.js";
...
program
    ...
    try {
        ...
        if (enablePushToTalk) {
            console.log(colors.warn("Push-to-talk uses a global hotkey listener (Ctrl+Win) which some antivirus tools flag as keylogger behavior."));
